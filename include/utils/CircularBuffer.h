...
/// Adapted from
/// https://github.com/laboshinl/loam_velodyne/blob/master/include/loam_velodyne/CircularBuffer.h
...
class CircularBuffer {
 public:
  CircularBuffer(const size_t &capacity = 200)
      : capacity_(capacity), size_(0), start_idx_(0) {
   ...
   */
  const T &first() const { return buffer_[start_idx_]; }

  T &first() { return buffer_[start_idx_]; }
